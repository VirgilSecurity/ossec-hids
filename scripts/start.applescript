...
tell application "Terminal"
	...
	do script cd_ossec_path & "docker-compose down && docker-compose pull && docker-compose up -d"
	activate
	...
	my makeTab()
	do script cd_ossec_path & "docker-compose logs -f ossec-client-2" in front window
	
	my makeTab()
	do script cd_ossec_path & "docker-compose logs -f ossec-client-3" in front window
